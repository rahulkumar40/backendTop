                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-2 border rounded-lg transition duration-200 focus:outline-none focus:ring-2 ${
                                    errors.oldPassword ? "border-red-500 focus:ring-red-200" : "focus:ring-blue-200 focus:border-blue-400"
                                }`}
                                placeholder="Your current password"
                                autoComplete="current-password"
                            />
                            {errors.oldPassword && (
                                <span className="text-red-500 text-sm mt-1 block">{errors.oldPassword.message}</span>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-2 border rounded-lg transition duration-200 focus:outline-none focus:ring-2 ${
                                    errors.newPassword ? "border-red-500 focus:ring-red-200" : "focus:ring-blue-200 focus:border-blue-400"
                                }`}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-2 border rounded-lg transition duration-200 focus:outline-none focus:ring-2 ${
                                    errors.confirmPassword ? "border-red-500 focus:ring-red-200" : "focus:ring-blue-200 focus:border-blue-400"
                                }`}
